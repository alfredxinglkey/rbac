    ...
    public class PermissionController : Controller
    {
        ...
        public IActionResult PermissionTree(string code)
        {
            ...
            using (_dbContext)
            {
                ...
                var sql = @"SELECT P.Code,P.MenuGuid,P.Name,P.ActionCode,IFNULL(S.RoleCode,'') AS RoleCode,(CASE WHEN S.PermissionCode IS NOT NULL THEN 1 ELSE 0 END) AS IsAssigned FROM DncPermission AS P 
